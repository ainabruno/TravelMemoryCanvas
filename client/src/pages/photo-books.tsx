...
import { BookOpen, Image as ImageIcon, Layout, Palette } from "lucide-react";
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 p-2 border rounded">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Organisation intelligente des photos</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-2 border rounded">
                ...
                <div>
                  <h4 className="font-medium text-sm">Récits automatiques</h4>
                  <p className="text-xs text-gray-600">Génération de textes narratifs</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 p-2 border rounded">
                ...
                <div>
                  <h4 className="font-medium text-sm">Thèmes personnalisés</h4>
                  <p className="text-xs text-gray-600">Styles adaptés à votre voyage</p>
                </div>
              </div>
            </div>
          </CardContent>
